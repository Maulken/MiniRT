...
#    Updated: 2024/08/20 14:16:24 by vharatyk         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = main.c \
 init.c clear.c \
 parsing/parsing.c  parsing/check.c  parsing/get_file.c  parsing/utils.c parsing/conversion.c parsing/check_object.c parsing/check_object2.c parsing/check_type.c parsing/check_utils.c parsing/ft_atof.c parsing/utils2.c\
