...
/*   Updated: 2024/08/18 20:48:26 by vmassoli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_colors_parse(char *arg, t_color colors)
{
	char **rbg;
...
int	ft_parse_R(char *line, t_scene scene)
{
	char **tab;
	int i;
...
int	ft_parse_A(char *line, t_scene scene)
{
	char **tab;
	int i;
